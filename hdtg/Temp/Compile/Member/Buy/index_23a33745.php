...
URL = 'http://localhost/hdtg/index.php/Member/Buy/index/gid/11';
...
CONTROLLER = 'http://localhost/hdtg/index.php/Member/Buy';
ACTION = 'http://localhost/hdtg/index.php/Member/Buy/index';
...
CONTROLLER_VIEW = 'http://localhost/hdtg/hdtg/Member/View/Buy';
HISTORY = 'http://localhost/hdtg/index.php/Index/Detail/index/gid/11';
</script>
...
<body>
	...
	<!-- 载入公共头部文件-->
	<link href="http://localhost/hdtg/hdtg/Member/View/Public/css/buy.css" type="text/css" rel="stylesheet" >
	<div class='position'>
		...
		<div id="main">
			...
			<tbody>
				<tr>
					<td>
						<a href="<?php echo U('Index/Detail/index',array('gid'=>$goods['gid']));?>"><?php echo $goods['main_title'];?></a>
					</td>
					<td class='goods-num'>
