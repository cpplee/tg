...
URL = 'http://localhost/hdtg/index.php/Member/Index/collect';
...
CONTROLLER = 'http://localhost/hdtg/index.php/Member/Index';
ACTION = 'http://localhost/hdtg/index.php/Member/Index/collect';
...
CONTROLLER_VIEW = 'http://localhost/hdtg/hdtg/Member/View/Index';
HISTORY = 'http://localhost/hdtg/index.php/Member/Account/index';
</script>
...
<div id="main">
	<div class='left'>
		...
		<div id="content">
		<link href="http://localhost/hdtg/hdtg/Member/View/Public/css/index.css" type="text/css" rel="stylesheet" >
		<div class='collect-nav'>
			<a href="<?php echo U('Member/Index/collect');?>" class='active'>全部</a>
			<a href="<?php echo U('Member/Index/collect',array('status'=>1));?>">进行中的团购</a>
			<a href="<?php echo U('Member/Index/collect',array('status'=>2));?>">已结束</a>
		</div>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class='btn' href="<?php echo U('Member/Buy/index',array('gid'=>$v['gid']));?>">购买</a><a href="<?php echo U('Member/Index/delCollect',array('gid'=>$v['gid']));?>">删除</a>
						</td>
					</tr>
					<?php }?>
				</tbody>
