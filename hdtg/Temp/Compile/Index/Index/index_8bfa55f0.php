...
<!-- 商品过滤开始 -->
	...
	<!-- 商品过滤结束 -->
	<link href="http://localhost:88/hdtg/hdtg/Index/View/Public/css/index.css" type="text/css" rel="stylesheet" >
	<!-- 页面主体开始 -->
	<div id="main">
		<div class='content'>
			...
			<div class='item'>
				<div class='cover'>
					<a href="<?php echo U('Detail/index',array('gid'=>$v['gid']));?>"><img src="<?php echo $v['goods_img'];?>"/></a>
				</div>
				<a class='link' href="">
				...
				<p class='detail'>
					...
					<span>门店价<span><?php echo $v['old_price'];?></span></span>
					<a href=""></a>
				</p>
				<p class='total'>
