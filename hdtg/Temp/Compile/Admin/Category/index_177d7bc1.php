...
<div id="content">
	<table id="table" class='table table-striped table-bordered'>
		...
		<?php foreach ($data as $k=>$v){?>
			<tr class="level_<?php echo $v['_level'];?> pid_<?php echo $v['pid'];?>" cid="<?php echo $v['cid'];?>" level="<?php echo $v['_level'];?>">
				<td><a class='btn btn-mini btn-info unfold' style="font-size:16px;" href="">+</a></td>
				<td>|-<?php echo $v['_html'];?><?php echo $v['cname'];?></td>
				...
				<td>
					...
					<a class='btn btn-small' href="<?php echo U('Admin/Category/del');?>/cid/<?php echo $v['cid'];?>">删除</a>
				</td>
			</tr>
		<?php }?>	
		</tbody>
